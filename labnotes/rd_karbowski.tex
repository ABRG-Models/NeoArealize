...
\nabla\vcdot\mb{J}_i & = D \dvrg a_i \\
%
& \quad - D^n a_i \dvrg n - D^n \nabla n \vcdot \nabla a_i
%
- D' a_i \dvrg \hat{a}_i - D' \nabla \hat{a}_i \vcdot \nabla a_i \\
%
& \quad - a_i\nabla\vcdot\mb{g}_i - \mb{g}_i\vcdot\nabla a_i
\end{split}
\end{equation}

Values for $D'$ between 0.01 and -0.006 make small differences to the
...
not identical those in section~\ref{sec:comp1}.
