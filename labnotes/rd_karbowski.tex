...
\mb{J}_i(\mb{x},t) = D \nabla \big(a_i(\mb{x},t) - \frac{D'}{N} \textstyle \sum_{p\ne i}^N a_p(\mb{x},t) \big) - a_i
\sum_{j=1}^M \big(\gamma_{i,j} \nabla\rho_j(\mb{x}) \big)
\end{equation}
%
...
current. This successfully produced competition between 2 TC types
branching in the absence of any guidance molecules with $D'$ set to a
value of 0.2.
