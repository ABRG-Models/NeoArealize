...
convert -verbose -density 450 -trim "barrel_equations.pdf[0]" -quality 100 -antialias -flatten -crop 2950x245+390+4020 "WBEqns_09_to_09.jpg" &

convert -verbose -density 450 -trim "barrel_equations.pdf[0]" -quality 100 -antialias -flatten -crop 2950x225+390+4500 "WBEqns_10_to_10.jpg" &
