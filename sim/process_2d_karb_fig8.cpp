/*
 * Reproduce approximate behaviour of Fig 8 of the Karbowski 2004
 * paper in our 2D system of arbitrary boundary shape. 2 Fgf8 sources.
 */
...
int main (void)
{
    ...
    string worldName("2dkarb_f8_dualfgf8");
